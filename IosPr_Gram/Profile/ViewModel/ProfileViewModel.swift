...
//        }
//        if bio.isEmpty == false , bio != user?.bio{
//            user?.bio = bio
//        }
//    }
//    
...
class ProfileViewModel {
    ...
    func loadUserPosts() async {
        ...
        self.posts=posts
//        do {
//            let documents = try await Firestore.firestore().collection("posts").whereField("userId", isEqualTo: user?.id ?? "").getDocuments().documents
//            
//            var posts: [Post] = []
//            for document in documents {
//                let post = try document.data(as: Post.self)
